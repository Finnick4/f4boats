...
scoreboard players operation @s finnick4.boats.time.decimal.1 *= .10 finnick4.boats.calc
scoreboard players operation @s finnick4.boats.time.decimal.1 /= .20 finnick4.boats.calc
...
execute if score @s finnick4.boats.calc matches 0 run scoreboard players set @s finnick4.boats.time.decimal.2 5
execute if score @s finnick4.boats.calc matches 1 run scoreboard players reset @s finnick4.boats.time.decimal.2
